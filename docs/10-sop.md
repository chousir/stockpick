...
- **第 3 節**：各族群領頭羊
- **第 5 節**：族群輪動機械基準（非挑股池・前 10 檔）
- **第 6 節**：領先次產業深度解讀（由 2.8 雷達挑 top-N、逐塊列成員股）

挑股以 picks.md 精選清單或 candidates_enriched.csv 為準（第 5 節僅族群輪動參考、勿直接照挑），記下股號（如 `2330`、`3008`、`6147`...）。
